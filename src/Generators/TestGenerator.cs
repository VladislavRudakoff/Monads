...
{
    private const string PrimitiveAttributeFullName = "Monads.Attributes.PrimitiveAttribute";
    private const string RootPrimitiveAttributeFullName = "Monads.Attributes.RootPrimitiveAttribute";
